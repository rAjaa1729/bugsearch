...
class TestUser(unittest.TestCase):
    ...
    def test_find_followers(self):
        result=User.find_followers(user_id=self.user_id)
        self.assertEqual(len(result),0)
    
    def test_find_followings(self):
        result=User.find_followings(user_id=self.user_id)
        self.assertEqual(len(result),0)
    
    def test_set_password(self):
        result=User.set_password(username=self.username,passcode=self.passcode)
